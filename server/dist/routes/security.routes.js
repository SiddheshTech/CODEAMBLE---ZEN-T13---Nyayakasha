 ...
 */
securityRouter.post('/sessions/revoke', requireAuth, async (req, res) => {
    try {
 ...
 */
securityRouter.get('/audit-log', requireAuth, async (req, res) => {
    try {
 ...
 */
securityRouter.get('/validator/duress-alerts', requireAuth, requireRole('independent_validator'), async (req, res) => {
    try {
