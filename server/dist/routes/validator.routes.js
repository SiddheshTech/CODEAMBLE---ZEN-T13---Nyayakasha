 ...
 */
validatorRouter.get('/dashboard', requireAuth, requireRole('independent_validator', 'court_authority'), async (req, res) => {
    try {
 ...
 */
validatorRouter.post('/vote', requireAuth, requireRole('independent_validator', 'court_authority'), async (req, res) => {
    try {
 ...
 */
validatorRouter.post('/duress/acknowledge', requireAuth, requireRole('independent_validator', 'court_authority'), async (req, res) => {
    try {
 ...
 */
validatorRouter.get('/activity-log', requireAuth, requireRole('independent_validator', 'court_authority'), async (req, res) => {
    try {
 ...
 */
validatorRouter.get('/analytics/aggregate', async (req, res) => {
    try {
 ...
 */
validatorRouter.post('/analytics/:id/escalate', async (req, res) => {
    try {
        const { id } = req.params;
